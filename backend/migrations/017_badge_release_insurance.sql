...
-- Empty string ('') may exist on old rows; new releases must specify a tier.
ALTER TABLE badge_releases ADD COLUMN insurance TEXT NOT NULL DEFAULT '';
ALTER TABLE badge_definitions ADD COLUMN insurance TEXT NOT NULL DEFAULT '';
...
ALTER TABLE badge_definitions DROP COLUMN insurance;
ALTER TABLE badge_releases DROP COLUMN insurance;
